"""
=============================================================
🤖 AGENTE PRO - Bot de Telegram
=============================================================

Usa tu agente con las 10 herramientas desde Telegram.
...
CONFIGURACIÓN (.env):
  ...
  EMAIL_PASSWORD=xxxx-xxxx-xxxx-xxxx         (opcional)
...
Hablas español de forma amigable. Tienes 10 herramientas: buscar_en_web, enviar_correo,
leer_pdf, leer_excel_csv, consultar_base_datos, guardar_archivo, traducir_texto,
generar_grafica, resumir_texto, obtener_clima.

REGLAS:
1. Responde en español, de forma concisa (Telegram tiene límite de caracteres)
...
def procesar_con_claude(user_id, mensaje_texto):
    """Envía un mensaje a Claude y procesa la respuesta con herramientas."""
    client = Anthropic()
...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    bienvenida = (
        ...
        f"Tengo 10 herramientas para ayudarte:\n\n"
        f"🔍 Búsqueda web\n"
        f"📧 Enviar correos\n"
        f"📄 Leer PDFs\n"
        f"📊 Leer Excel/CSV\n"
        ...
        f"📝 Resumidor\n"
        f"🌤️ Clima\n\n"
        f"Escríbeme lo que necesites. Ejemplos:\n"
        f'• "Busca noticias sobre IA"\n'
        f'• "¿Qué clima hace en Guadalajara?"\n'
        f'• "Traduce al inglés: Buenos días"\n'
        f'• "¿Qué tareas tengo pendientes?"\n\n'
        f"Comandos:\n"
        f"/start - Ver este mensaje\n"
        f"/limpiar - Borrar historial de conversación\n"
        f"/herramientas - Ver herramientas disponibles\n"
...
def main():
    ...
    print("")
    print("=" * 50)
    print("  🤖 AGENTE PRO - Bot de Telegram")
    print("=" * 50)
    print("")
